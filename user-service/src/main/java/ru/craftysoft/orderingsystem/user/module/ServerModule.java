...
import ru.craftysoft.orderingsystem.user.controller.UserController;
...
public class ServerModule {
    ...
    @Provides
    @Singleton
    static Server grpcServer(PropertyResolver propertyResolver, UserController controller) {
