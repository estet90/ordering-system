package ru.craftysoft.orderingsystem.executor.module;
...
import ru.craftysoft.orderingsystem.executor.controller.ExecutorController;
...
public class ServerModule {
    ...
    @Provides
    @Singleton
    static Server grpcServer(PropertyResolver propertyResolver, ExecutorController controller) {
